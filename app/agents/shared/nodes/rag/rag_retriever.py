"""
RAG Retriever Node - busca e valida arquivos NEWAVE.
Compartilhado entre single deck e multi-deck agents.
"""
import json
...
def rag_retriever_node(state: Dict[str, Any]) -> dict:
    """
    ...
    Args:
        state: Estado do agente (SingleDeckState ou MultiDeckState)
    """
    query = state["query"]
...
def rag_simple_node(state: Dict[str, Any]) -> dict:
    """
