...
class ClastValoresTool(NEWAVETool):
    ...
    def execute(self, query: str, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            # ETAPA 3: Identificar tipo de valor solicitado
            print("[TOOL] ETAPA 3: Identificando tipo de valor solicitado...")
    ...
    def get_description(self) -> str:
        ...
        - "dados do CLAST"
        - "CVU de curto prazo da classe ANGRA 1"
