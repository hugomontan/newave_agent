...
import { FileText, GitCompare, ArrowRight, Brain, Calendar, ArrowLeft } from "lucide-react";
import { listAvailableDecompDecks, DeckInfo } from "@/lib/api";
...
export default function NewaveHome() {
  ...
  useEffect(() => {
    const fetchDecks = async () => {
      try {
        const response = await listAvailableDecompDecks();
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-2xl font-bold text-foreground">DECOMP Agent</h1>
            </div>
          </div>
        </div>
      </header>
        ...
        <div className="max-w-4xl w-full space-y-8">
          ...
          >
            <h2 className="text-4xl font-bold text-foreground">
              Escolha o Modo de Análise DECOMP
            </h2>
            <p className="text-lg text-muted-foreground">
              Selecione como deseja analisar os decks DECOMP disponíveis
            </p>
          </motion.div>
              ...
              <Card className="h-full hover:shadow-lg transition-shadow cursor-pointer border-2 hover:border-primary/50">
                <CardHeader>
                  ...
                  <CardDescription className="text-base">
                    Analise um deck DECOMP específico. Faça upload de um deck ou escolha entre os decks disponíveis no repositório.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <Button
                      onClick={() => router.push("/decomp/analysis")}
                      className="w-full"
                      size="lg"
                    >
            ...
            >
              <Card className="h-full hover:shadow-lg transition-shadow cursor-pointer border-2 hover:border-primary/50">
                <CardHeader>
                  ...
                  <CardDescription className="text-base">
                    Compare dados entre múltiplos decks DECOMP. Selecione N decks para análise histórica ou compare apenas dois para comparação direta.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <Button
                      onClick={() => router.push("/decomp/comparison")}
                      className="w-full"
                      size="lg"
                      variant="default"
                    >
              ...
              <Card className="h-full hover:shadow-lg transition-shadow cursor-pointer border-2 hover:border-primary/50">
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <Button
                      onClick={() => router.push("/decomp/llm-mode")}
                      className="w-full"
                      size="lg"
                      variant="outline"
                    >
