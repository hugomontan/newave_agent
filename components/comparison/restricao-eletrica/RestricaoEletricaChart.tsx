...
export function RestricaoEletricaChart({ data, restricao, patamar }: RestricaoEletricaChartProps) {
  // Validar dados
  ...
  // Título dinâmico
  let chartTitle = "Limites Superiores";
  if (restricao && patamar) {
    chartTitle = `${restricao} - ${patamar}`;
  } else if (restricao) {
    chartTitle = restricao;
  } else if (patamar) {
    chartTitle = patamar;
  }
