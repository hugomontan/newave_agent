...
interface ReservatorioInicialChartProps {
  data: ChartData;
}

export function ReservatorioInicialChart({ data }: ReservatorioInicialChartProps) {
  // Validar dados
  ...
  // Cores para as linhas (uma cor por usina)
  const colors = [
    "#8884d8", "#82ca9d", "#ffc658", "#ff7300", "#00ff00", "#ff00ff",
    "#00ffff", "#ffff00", "#ff00ff", "#00ff00", "#0000ff", "#ff0000"
  ];
  ...
  return (
    ...
    >
      <h3 className="text-base sm:text-lg font-semibold mb-4 text-card-foreground">
        Evolução do Volume Inicial por Usina
      </h3>
