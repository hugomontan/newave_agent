...
interface LimitesIntercambioComparisonChartProps {
  data: ChartData;
  config?: {
    type?: string;
    title?: string;
...
export function LimitesIntercambioComparisonChart({ 
  data, 
  config 
}: LimitesIntercambioComparisonChartProps) {
  ...
  return (
    <div className="bg-card border border-border rounded-lg p-4 sm:p-6">
      <h4 className="text-base sm:text-lg font-semibold text-card-foreground mb-4">
        {config?.title || "Evolução dos Limites de Intercâmbio"}
      </h4>
