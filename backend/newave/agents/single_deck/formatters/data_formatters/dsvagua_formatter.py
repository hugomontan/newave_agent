...
from backend.newave.agents.shared.formatting.data_processors.vazoes_processor import VazoesDataProcessor
from backend.newave.agents.single_deck.formatters.text_formatters.simple import format_dsvagua_simple
