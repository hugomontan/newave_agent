...
import { uploadDecompDeck, UploadResponse } from "@/lib/api";
...
export function FileUploadDecomp({ onUploadSuccess, disabled }: FileUploadProps) {
  ...
  const handleFile = async (file: File) => {
    ...
    try {
      const response = await uploadDecompDeck(file);
