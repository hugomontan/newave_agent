...
import { CadastroHidrTable } from "./CadastroHidrTable";
import type { SingleDeckVisualizationData } from "../shared/types";

interface CadastroHidrViewProps {
  visualizationData: SingleDeckVisualizationData;
}

export function CadastroHidrView({ visualizationData }: CadastroHidrViewProps) {
